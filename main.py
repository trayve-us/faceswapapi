...
print("🔧 Forcing CPU usage for Render deployment")
...
class FaceSwapProcessor:
    ...
    def __init__(self):
        ...
        print(f"Using device: {self.device} (forced for deployment)")
...
if __name__ == "__main__":
    ...
    print("Starting CodeFormer Face Swap Server for Render deployment...")
